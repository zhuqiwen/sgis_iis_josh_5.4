                            ...
                            '<div class="modal-body">' +
                                ...
                                '<div id="myTabContent" class="tab-content">' +
                                    ...
                                    '<div class="tab-pane fade" id="geo_distribution_world">' +
                                        '<div class="row">' +
                                            '<div class="col-md-12">' +
                                                '<div id="geo_distribution_world_map_label" style="height: 100px;"></div>' +
                                            '</div>' +
                                            '<div class="col-md-12">' +
...
$(document).on('click', '#charts_launcher_button', function () {
    ...
    $('#geo_distribution_world_map').vectorMap({
        ...
        onLabelShow: function(event, label, code) {
            ...
            $('#geo_distribution_world_map_label').html('<p>' + (Math.floor(Math.random() * (100 - 2) + 2)) + ' alumni in ' + label.text() + '</p>');
