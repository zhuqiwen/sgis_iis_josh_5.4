...
DISPLAY;
    ...
    /**
     * Create-Button and Modal pair
     * [
     *      'button' => [
     *                      'button_color' => 'btn-primary',
     *                      'btn_data_target' => 'modal id',
     *                      'button_name' => 'any string that appears on button',
     *                  ],
     *      'modal' => [
     *                      'modal_id' => '',
     *                      'modal_size' => 'modal-lg',
     *                      'modal_title' => '',
     *                      'modal_body_layout' => 'col-md-12', or 'col-md-12 col-md-offset-1'
     *                      'form_html' => '',
     *                      'modal_button_cancel_name' => 'Close', or 'Cancel'
     *                      'modal_button_save_name' => 'Save', or 'Update', or 'Create'
     *                      'modal_button_save_color' => 'btn-primary', or  alike
     *                      'modal_button_save_id' => 'button id'
     *                      'modal_button_save_form_id' => 'form="form_id"'
     *                  ],
     * ]
     */
	 ...
	 * @return string
	 */
	public static function buttonModalPairResponsive(array $configuration)
	{

		foreach ($configuration as $key => $item_group)
		{
			foreach ($item_group as $attribute => $value)
			{
				$$attribute = $value;
			}
		}
		...
		if(!isset($form_html))
		{
			$form_html = <<<FORM
				...
				<form action="example_action" method="post" id="form_id">
	            <p>
...
FORM;
		...
		$button_modal = <<<BTNMDL
	        <button type="button" class="btn btn-responsive button-alignment $button_color" data-toggle="modal" data-target="$btn_data_target">$button_name</button>
	        <div class="modal fade in" id="$modal_id" tabindex="-1" role="dialog" aria-hidden="false">
	            <div class="modal-dialog $modal_size">
	                <div class="modal-content">
	                    ...
	                    <div class="modal-body">
	                        <div class="row">
	                            <div class="$modal_body_layout">
	                                $form_html
	                            </div>
	                        </div>
	                    </div>
	                    <div class="modal-footer">
	                        <button type="button" data-dismiss="modal" class="btn btn-default">$modal_button_cancel_name</button>
	                        <button type="button" class="btn $modal_button_save_color" $modal_button_save_form_id>$modal_button_save_name</button>
	                    </div>
	                </div>
	            </div>
	        </div>
