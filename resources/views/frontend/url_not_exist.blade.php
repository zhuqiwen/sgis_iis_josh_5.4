...
<div class="container">
    ...
    <div class="row">
        <div class="box animation flipInX">
            ...
            <i class="livicon icon" data-name="cloud-rain" data-size="100" data-loop="true" data-c="#01bc8c" data-hc="#01bc8c"></i>

            <h3 class="text-primary">Ooops, the page does not exist.</h3>
        </div>
    </div>
    <!-- //Content Section End -->
</div>
