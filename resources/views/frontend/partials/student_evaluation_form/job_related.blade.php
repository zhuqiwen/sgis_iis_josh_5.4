<div class="tab-pane" id="tab4">
    <div class="row">
        <div class="col-sm-12">
            <h4 class="info-text"><b>Job Advice</b></h4>
        </div>
                ...
                <div class="col-md-6">
                    ...
                    <div class="radio">
                        <label for="radios-1">
                            ...
                            Outstanding (top 10%): The intern learned and applied new skills <strong>very rapidly</strong>.
                        </label>
                    </div>
                    <div class="radio">
                        <label for="radios-1">
                            <input type="radio" name="intern_student_evaluation_development_rating" id="radios-1" value="2">
                            Good (top 25%): The intern learned and applied new skills <strong>relatively fast</strong>.
                        </label>
                    </div>
                    <div class="radio">
                        <label for="radios-1">
                            <input type="radio" name="intern_student_evaluation_development_rating" id="radios-2" value="1">
                            Fair (top 50%): The intern learned and applied new skills.
                        </label>
                    </div>
                    <div class="radio">
                        <label for="radios-0">
                            <input type="radio" name="intern_student_evaluation_development_rating" id="radios-3" value="-1">
                            Poor (bottom 50%): The intern <strong>did not</strong> learn or apply new skills well.
                        </label>
                    </div>
                </div>
