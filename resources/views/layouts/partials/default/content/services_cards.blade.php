...
<div class="row">
    ...
    <div class="text-center">
        <h3 class="border-primary"><span class="heading_border bg-primary">What you can do with the us</span></h3>
    </div>
    <div class="col-sm-6 col-md-3 wow bounceInLeft" data-wow-duration="0.5s">
        <div class="box">
            <a href="#">
                <div class="box-icon">
    ...
    <div class="col-sm-6 col-md-3 wow bounceInDown" data-wow-duration="0.5s" data-wow-delay="0.1s">
        <!-- Box Start -->
        <div class="box">
            <a href="#">
    ...
    <!-- only alumni role can see this -->
    <div class="col-sm-6 col-md-3 wow bounceInUp" data-wow-duration="0.5s" data-wow-delay="0.1s">
        <div class="box">
            <a href="#">
                ...
                <div class="info">
                    <h3 class="warning text-center">Alumni</h3>
                    <p>Get connected with others</p>
                    <p>Apply to be a SGIS alumnus</p>
    ...
    <div class="col-sm-6 col-md-3 wow bounceInRight" data-wow-duration="0.5s" data-wow-delay="0.1s">
        <div class="box">
            <a href="#">
